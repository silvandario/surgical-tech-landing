...
const FeatureSection = () => {
  return (
    <section id="features" className="features py-20 lg:py-32 px-6 lg:px-12 bg-gradient-to-br from-[#0d2847] to-[#081a2f] text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-1">
            <div className="feature-item border-t border-white/10 py-8 lg:py-10 hover:bg-white/5 transition-all duration-300 rounded-lg px-4">
            ...
            <div className="feature-item border-t border-white/10 py-8 lg:py-10 border-b hover:bg-white/5 transition-all duration-300 rounded-lg px-4">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div className="flex-1">

...
const FeatureSection = () => {
  return (
    <section id="features" className="features py-20 lg:py-32 px-6 lg:px-12 bg-black text-white">
          ...
          <div className="space-y-1">
            ...
            <div className="feature-item border-t border-white/10 py-8 lg:py-10">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="text-6xl lg:text-8xl font-bold text-white/10">02</div>
              </div>
            </div>
            ...
            <div className="feature-item border-t border-white/10 py-8 lg:py-10">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="text-6xl lg:text-8xl font-bold text-white/10">03</div>
              </div>
            </div>

            <div className="feature-item border-t border-white/10 py-8 lg:py-10 border-b">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div className="flex-1">
                ...
                <div className="text-6xl lg:text-8xl font-bold text-white/10">04</div>
              </div>
            </div>
          </div>
        </div>
